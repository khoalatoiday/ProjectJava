...
public class DataController {
    ...
    /**
     * Phương thức này trả về một đối tượng trong danh sách với id cho trước
     *
     * @param readers
     * @param readerID
     * @return
    ...
    public void updateBRMFile(ArrayList<BookReaderManagement> list, String filename) {// cập nhật lại file
